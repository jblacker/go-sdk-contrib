...
## [0.4.0](https://github.com/jblacker/go-sdk-contrib/compare/hooks/open-telemetry-v0.3.6...hooks/open-telemetry/v0.4.0) (2025-10-25)


### ⚠ BREAKING CHANGES

* attribute setter callbacks for otel hooks and remove deprecated constructors  ([#311](https://github.com/jblacker/go-sdk-contrib/issues/311))
...
* **deps:** update module go.opentelemetry.io/otel/sdk/metric to v1 ([#371](https://github.com/jblacker/go-sdk-contrib/issues/371)) ([50fcef6](https://github.com/jblacker/go-sdk-contrib/commit/50fcef618aa7eb3800d9ab476dbebf61f5ee401c))
* **deps:** update opentelemetry-go monorepo ([#318](https://github.com/jblacker/go-sdk-contrib/issues/318)) ([d3c8e87](https://github.com/jblacker/go-sdk-contrib/commit/d3c8e8752762a9df8bf796afe4f93c2741887463))
* **deps:** update opentelemetry-go monorepo to v1.14.0 ([#108](https://github.com/jblacker/go-sdk-contrib/issues/108)) ([711bc52](https://github.com/jblacker/go-sdk-contrib/commit/711bc5286b0fcfbd23daf0d6c41253f07571e97b))
* **deps:** update opentelemetry-go monorepo to v1.15.1 ([#189](https://github.com/jblacker/go-sdk-contrib/issues/189)) ([c42a1c4](https://github.com/jblacker/go-sdk-contrib/commit/c42a1c4371cc219cdfc7ae23c940641548482306))
* **deps:** update opentelemetry-go monorepo to v1.21.0 ([#383](https://github.com/jblacker/go-sdk-contrib/issues/383)) ([f417648](https://github.com/jblacker/go-sdk-contrib/commit/f417648ccb2875562eb9215eb830b0a0eba2e44c))
* **deps:** update opentelemetry-go monorepo to v1.25.0 ([#493](https://github.com/jblacker/go-sdk-contrib/issues/493)) ([6241825](https://github.com/jblacker/go-sdk-contrib/commit/62418255a6a0c48cd6ad8b94c9fd5a4c6943b1da))
* set error state with a message ([#205](https://github.com/jblacker/go-sdk-contrib/issues/205)) ([ce14e22](https://github.com/jblacker/go-sdk-contrib/commit/ce14e22870a9329fe02dd7dba5634d62f9845728))


### ✨ New Features

* ⚠️ requires OpenFeature Go SDK v1.3.0 or above ⚠️ absorbed Hook API changes ([#130](https://github.com/jblacker/go-sdk-contrib/issues/130)) ([a65b009](https://github.com/jblacker/go-sdk-contrib/commit/a65b00957a425b89c261a979f81dcfdf2f5a2bcb))
* api change to support more usecases ([#254](https://github.com/jblacker/go-sdk-contrib/issues/254)) ([c855a67](https://github.com/jblacker/go-sdk-contrib/commit/c855a677e34d3f6b1d8b24bc721ce389a19f742f))
* attribute setter callbacks for otel hooks and remove deprecated constructors  ([#311](https://github.com/jblacker/go-sdk-contrib/issues/311)) ([27f7ca7](https://github.com/jblacker/go-sdk-contrib/commit/27f7ca7d17667b33e2ed8206b96dc304e5d33454))
* metric hooks ([#217](https://github.com/jblacker/go-sdk-contrib/issues/217)) ([3a055e4](https://github.com/jblacker/go-sdk-contrib/commit/3a055e45a2ef549696ac2e7eb0a0c388ee3bbb83))
* OTel hook changes for hook interface updates ([#644](https://github.com/jblacker/go-sdk-contrib/issues/644)) ([38b3b6f](https://github.com/jblacker/go-sdk-contrib/commit/38b3b6f80bc31b815840903d26c4b4b3cf8ced41))
* otel hook error status override option ([#209](https://github.com/jblacker/go-sdk-contrib/issues/209)) ([48fd3f6](https://github.com/jblacker/go-sdk-contrib/commit/48fd3f6f12a07c2e0e6a92e516e5bab071e8bff0))
* **otel:** add NewMetricsHook, use api interface instead of SDK type ([#530](https://github.com/jblacker/go-sdk-contrib/issues/530)) ([0472b0d](https://github.com/jblacker/go-sdk-contrib/commit/0472b0d59732be7f93b5e79875c0a61fcd4a35e6))
* update OpenTelemetry hook to use the latest semconv ([#713](https://github.com/jblacker/go-sdk-contrib/issues/713)) ([4d0a91c](https://github.com/jblacker/go-sdk-contrib/commit/4d0a91cf71db9c751240bfa476b4fab226b7e909))
